...
export const $authPlugin = /** @type {s.Schema<AuthPlugin<any>>} */ (
    s.$object({
...
export const $config = s.$object({
    redis: s.$object({
         ...
         */
        socket: /** @type {s.$Optional<s.Schema<import('@redis/client').RedisClientOptions['socket']>>} */ (
            s.$any.optional
        ),
    }),
    postgres: s.$string,
